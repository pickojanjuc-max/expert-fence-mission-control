...
export default function ComponentList({ runs, finishes, intersectionMap, shape }) {
  const { rows, consolidated, runSummary, unsolved } = buildBOM(runs, finishes, intersectionMap, shape, { skuFamily: "balustrade" });
